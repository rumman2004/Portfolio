...
// If frontend + backend are in the SAME Vercel project,
...
export const aboutAPI = {
    get: () => api.get("/about"),
    createOrUpdate: (data) =>
        api.post("/about", data, { headers: { "Content-Type": "multipart/form-data" } }),
    update: (data) =>
        api.post("/about", data, { headers: { "Content-Type": "multipart/form-data" } }),
};
...
export const skillsAPI = {
    ...
    update: (id, data) => api.put(`/skills/${id}`, data, { headers: { "Content-Type": "multipart/form-data" } }),
